...
in your form:</strong>'.$error.'</div>';
 ...
 if (mail("info@youremail.com", " Call back request from Home Insurance Page", 
...
<body data-spy="scroll" data-target=".navbar-collapse">
  ...
  <div id="home-insurance-banner"><br>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div align="center" class="col-md-4 col-sm-6">
               ...
               <img src="images/cheap-home-insurance.png" classs="img-responsive" alt="cheap-home-insurance">

                <h2>Already Insured<br /> <span style="font-size: 20px">for Home Insurance?</span></h2><br />
        ...
        <div align="center" class="col-md-4 col-sm-6">
            ...
            <img src="images/no-home-insurance.png" classs="img-responsive" alt="no-home-insurance"></p>


                <h2>Not Insured <br /><span style="font-size: 20px">for Home Insurance?</span></h2><br />
 ...
 <div id="insurance-company-features">
  ...
  </div><!--- /#insurance-company-features-->
...
<div class="faq-homes">
 ...
 <h2 align="center">Frequently Asked Questions About Home Insurance</h2><hr>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <p class="answer">Maecenas aliquet, lorem nec aliquam pulvinar, justo mauris aliquet sapien, sit amet maximus odio lacus at ex. Etiam porttitor, metus eu pharetra euismod, massa nibh interdum odio, sit amet feugiat tortor massa non turpis</p><br />
  ...
  <div class="insurance-home-img">
    
  </div><!--- /.insurance-home-img-->
